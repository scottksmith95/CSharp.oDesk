...
namespace CSharp.oDesk.Api.Impl
{
    /// <summary>
    /// Implementation of the <see cref="IResponseErrorHandler"/> that handles errors from oDesk's REST API, 
    /// interpreting them into appropriate exceptions.
    /// </summary>
    /// <author>Scott Smith</author>
    class oDeskErrorHandler : DefaultResponseErrorHandler
    {
        /// <summary>
        ...
        public override void HandleError(Uri requestUri, HttpMethod requestMethod, HttpResponseMessage<byte[]> response)
        {
            ...
            // if not otherwise handled, do default handling and wrap with oDeskApiException
            try
            {
